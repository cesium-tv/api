# Generated by Django 4.0.7 on 2022-08-25 21:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('importer', rest.models.ModuleAttributeField(choices=[('PeerTubeBackend', 'PeerTubeBackend'), ('RumbleBackend', 'RumbleBackend'), ('TimcastBackend', 'TimcastBackend')], max_length=32, module_name='rest.importer.backends')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', rest.models.ModuleAttributeField(blank=True, choices=[('PeerTubeBackend', 'PeerTubeBackend'), ('RumbleBackend', 'RumbleBackend'), ('TimcastBackend', 'TimcastBackend')], max_length=32, module_name='rest.auth.backends', null=True)),
