    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(db_collation='ci', max_length=32), blank=True, null=True, size=None)),
                ('search', django.contrib.postgres.search.SearchVectorField(null=True)),
        ...
        migrations.AlterUniqueTogether(
            name='queue',
            unique_together={('user', 'position'), ('user', 'video')},
        ),
        migrations.AlterUniqueTogether(
            name='like',
