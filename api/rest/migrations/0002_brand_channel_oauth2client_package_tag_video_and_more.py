# Generated by Django 4.1.6 on 2023-05-17 22:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('auth_params', rest.models.JSONNaClField(blank=True, null=True)),
                ...
                ('best_hour', models.PositiveSmallIntegerField(default=rest.models.get_random_hour)),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('video', 'url'), ('video', 'mime', 'width', 'height')},
            },
            bases=(rest.models.HashidsModelMixin, models.Model),
        ),
        ...
        migrations.CreateModel(
            name='ChannelMeta',
            fields=[
                ('channel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rest.channel')),
        ...
        migrations.CreateModel(
            name='VideoMeta',
            fields=[
                ('video_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rest.video')),
                ('metadata', models.JSONField()),
            ],
            bases=('rest.video',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('videosource_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rest.videosource')),
                ('metadata', models.JSONField()),
            ],
            bases=('rest.videosource',),
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to='rest.package')),
